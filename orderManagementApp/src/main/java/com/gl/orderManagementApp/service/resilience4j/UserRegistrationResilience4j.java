...
public class UserRegistrationResilience4j {
    ...
    @RateLimiter(name="service1", fallbackMethod = "fallbackForRegisterSeller2")
   // @RateLimiter(name = "service1", fallbackMethod = "rateLimiterfallback")
    ...
    public String registerSellerd(SellerDto sellerDto) {
    ...
    public String fallbackForRegisterSeller2(SellerDto sellerDto, Throwable t) {
        logger.error("Inside RateLimiter, cause - {}", t.toString());
        return "Inside RateLimiter fallback method. Some error occurred while calling service for seller registration";
    }
